...
function orientationChange(){
  switch(window.orientation){
    ...
    case undefined:
      ...
      // recentre les images
      $('.articles_pictures').css('margin-top', '0px');
    ...
    default:
      ...
      // affiche les boutons de changement de bague
      $('#boutons_bagues').show();

      // recentre les images
      $('.articles_pictures').css('margin-top', '40px');
  ...
  // redimensionne l'image de fond et replace l'image de fond
  var $img_background = $('img.bg');
  $img_background.height($img_background.parent().height() - 55);
...
function change_bague_size(){
  if (orientation_value == "paysage"){
    $("div.Magic360Contener").css('width', '183px');
    $("div.Magic360Contener").css('height', '180px');
    ...
    $("div.Magic360Contener").css('width', '240px');
    $("div.Magic360Contener").css('height', '239px');
